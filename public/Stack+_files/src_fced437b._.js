...
;
const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(("TURBOPACK compile-time value", "https://qatgobylvflaznkxntuc.supabase.co"), ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InFhdGdvYnlsdmZsYXpua3hudHVjIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjU3ODI5ODIsImV4cCI6MjA4MTM1ODk4Mn0.mmN2RA8IxWhw3l8pSlvFhR2yc7VFaf8ck7dJB_ORXCI"));
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/api/profile.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getMyProfile() {
    ...
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("profiles").select("id, nickname").eq("id", user.id).maybeSingle();
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$profile$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/api/profile.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/supabase.ts [app-client] (ecmascript)");
;
...
function AuthProvider({ children }) {
    _s();
    const { setUser, clearUser, setInitialized } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$useUserStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUserStore"])();
    const handleSession = async (session)=>{
        ...
        try {
            ...
            const profile = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$profile$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMyProfile"])();
            setUser({
                id: session.user.id,
...
_s(AuthProvider, "XvvXEysF/ly66lWyYLbUyhTg2vg=", false, function() {
    return [
...
//# sourceMappingURL=src_fced437b._.js.map